...
public class RamStatisticsPainter implements Runnable, Listener {
	...
	private void paint(){
		...
		int var5 = 5;
		var1 = this.format(var1, var5);
		var2 = this.format(var2, var5);
		var3 = this.format(var3, var5);
		var4 = this.format(var4, var5);
		...
		lines.add(ChatColorUtils.COLOR_CHAR + "7#     " + ChatColorUtils.COLOR_CHAR + "a-----------------------------" + this.format("", var5).replaceAll(" ", "-") + "   " + diffSpace + ChatColorUtils.COLOR_CHAR + "7#");
