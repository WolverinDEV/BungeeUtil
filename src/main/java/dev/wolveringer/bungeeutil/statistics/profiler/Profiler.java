...
public class Profiler {
	...
	public Long getLastTiming(String name) {
		if(isEnabled()) {
			return this.profiles.get(this.getStackMethodeName()).getLastTiming(name);
		} else {
			return -1L;
		}
	}
	...
	public Long getLastTiming(String method, String name) {
		if(isEnabled()) {
			return this.profiles.get(method).getLastTiming(name);
		} else {
			return -1L;
		}
	}
	...
	public void start(String name) {
		if(isEnabled()) {
			this.profiles.get(this.getStackMethodeName()).start(name);
		}
	}

	public void stop(String name) {
		if(isEnabled()) {
			this.profiles.get(this.getStackMethodeName()).stop(name);
		}
	}
