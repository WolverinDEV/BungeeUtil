...
class EmptyChannelWrapper implements ChannelHandlerContext {
	...
	public Channel channel() {
		return new Channel() {
			@Override
			public int compareTo(Channel arg0) { return 0; }
			
			@Override
			public <T> Attribute<T> attr(AttributeKey<T> arg0) { return null; }
			
			@Override
			public ChannelFuture writeAndFlush(Object arg0, ChannelPromise arg1) { return null; }
			
			@Override
			public ChannelFuture writeAndFlush(Object arg0) { return null; }
			
			@Override
			public ChannelFuture write(Object arg0, ChannelPromise arg1) { return null; }
			
			@Override
			public ChannelFuture write(Object arg0) { return null; }
...
public class WarpedChannelWrapper extends ChannelWrapper {
	...
	public WarpedChannelWrapper(net.md_5.bungee.netty.ChannelWrapper ctx, IInitialHandler h) {
		...
		try {
			Field f = net.md_5.bungee.netty.ChannelWrapper.class.getDeclaredField("remoteAddress");
			f.setAccessible(true);
			this.remoteAddress = (InetSocketAddress) f.get(ctx);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
