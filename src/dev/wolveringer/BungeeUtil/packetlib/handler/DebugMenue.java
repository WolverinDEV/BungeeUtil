...
import dev.wolveringer.bungeeutil.animations.inventory.InventoryViewChangeAnimations;
...
import dev.wolveringer.bungeeutil.inventory.anvil.AnvilGui;
import dev.wolveringer.bungeeutil.inventory.anvil.AnvilGuiListener;
...
import dev.wolveringer.bungeeutil.profile.PropertyMap;
	...
	public static void open(Player player){
		...
		i = new ItemStack(159, 1, (short) 14) {
			...
			public void click(final Click p) {
				...
				final PlayerNPC c = new PlayerNPC();
